...
class Task(db.Model):
  ...
  def __repr__(self):
      return f'<I am a Task. My Id is: {self.id},my description is {self.description}>'
...
class PersonTask(db.Model):
  ...
  # person = relationship(Person, backref=backref("children", cascade="all,delete"))
  # task = relationship(Task, backref=backref("task", cascade="all,delete"))
  ...
  def __repr__(self):
    return f'<I am a PersonTask. My PersonId is: {self.personid}, my TaskId is {self.taskid} and I am due by {self.dueby}>'
